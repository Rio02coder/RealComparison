...
class OAuthUserTokenViewTestCase(TestCase):
    """
        Tests the OAuth Sign Up View.
    """
    def setUp(self) -> None:
        self.url: str = reverse('oauth_user_token')
    ...
    ## URL Unit tests.
    def test_oauth_user_token_view_url(self) -> None:
        self.assertEqual(self.url, f'/user/token/oauth/')
    '''______________________________________________________________________________________'''

    ## Retrieve the user's token unit tests. 
